...
<head>
  ...
  <style>
    /* Add your cubic-bezier hover styles here */
    select:hover {
    ...
    select option:hover {
      background-color: #e0e0e0; /* Change this to your desired hover color for options */
    }
    ...
    function handleRadioSelection(value) {
      ...
      document.querySelectorAll('input[type="radio"]').forEach((radio) => {
        radio.nextElementSibling.style.color = ''; // Reset text color
      });

      // Apply styles based on selected value
      switch (value) {
        case 'male':
          document.getElementById('label-male').style.color = 'blue';
          break;
        case 'female':
          document.getElementById('label-female').style.color = 'pink';
          break;
        case 'other':
          const labelOther = document.getElementById('label-other');
          labelOther.style.color = getRandomColor(); // Set different color for each letter
          break;
      }
    }
...
<body>
  ...
  <form>
    <input type="radio" name="gender" value="male" onchange="handleRadioSelection('male')">
    <label id="label-male" for="male">Male</label><br>
    <input type="radio" name="gender" value="female" onchange="handleRadioSelection('female')">
    <label id="label-female" for="female">Female</label><br>
    <input type="radio" name="gender" value="other" onchange="handleRadioSelection('other')">
    <label id="label-other" for="other">Other</label>
  </form>
